 ...
 */
//@Controller
public class AppErrorController { //implements ErrorController, AppErrorControllerM {
...
//    }
    ...
    private Map<String, Object> getErrorAttributes(HttpServletRequest request, WebRequest webRequest,
                                                   boolean includeStackTrace/*, ErrorAttributeOptions options*/) {
//        RequestAttributes requestAttributes = new ServletRequestAttributes(request);
//        ErrorAttributeOptions options = new ErrorAttributeOptions();
        ErrorAttributeOptions errorAttributes = ErrorAttributeOptions.of(ErrorAttributeOptions.Include.MESSAGE);

//        return this.errorAttributes.getErrorAttributes(webRequest, includeStackTrace);
        return this.errorAttributes.getErrorAttributes(webRequest, errorAttributes);
    }
